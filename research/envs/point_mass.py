...
@SUITE.add()
def reach(time_limit=_DEFAULT_TIME_LIMIT, random=None, target_pos=(-1, 1), 
            target_size=0.015, environment_kwargs=None):
...
@SUITE.add()
def reach_l2(time_limit=_DEFAULT_TIME_LIMIT, random=None, target_pos=(-1, 1), 
            target_size=0.015, environment_kwargs=None):
  """Returns the hard point_mass task."""
  physics = Physics.from_xml_string(*get_model_and_assets())
...
@SUITE.add()
def reach_l2_random(time_limit=_DEFAULT_TIME_LIMIT, random=None, target_pos=(-1, 1), 
            target_size=0.015, environment_kwargs=None):
  """Returns the hard point_mass task."""
  physics = Physics.from_xml_string(*get_model_and_assets())
