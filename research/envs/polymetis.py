...
class PolyMetisEnv(gym.Env):
    ...
    def __init__(self, ip_address="localhost", port=50051, max_delta=0.05, initialization_noise=0.0, time_to_go=0.1, fix_gripper=False, use_quat=False, ee_link=7):
        super().__init__()
    ...
    def step(self, action):
        ...
        action = torch.clamp(self._ee_pos + action,
