...
if __name__ == "__main__":
    ...
    if len(paths) == 1 and paths[0].endswith('.yaml'):
        ...
        plotter.create_plot(paths, labels, title=args.title, xlabel=args.xlabel, ylabel=args.ylabel, 
                            x_key=args.x, y_keys=args.y, window_size=args.window, max_x_value=args.max_x)
