...
if __name__ == "__main__":
    ...
    parser.add_argument('--use-taskset', action='store_true', default=False, help="Whether or not to CPU load balance with taskset")
    ...
    if args.gpus is not None:
        assert isinstance(args.valid_gpus, list) and len(args.valid_gpus) >= args.gpus, "If GPU, must provide valid gpus >= num gpus"
